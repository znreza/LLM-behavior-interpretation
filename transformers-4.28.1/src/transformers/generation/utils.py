...
class GreedySearchDecoderOnlyOutput(ModelOutput):
    ...
    layer_tokens: Optional[Dict[int, int]] = None
...
class SampleDecoderOnlyOutput(ModelOutput):
    ...
    """
    print("###inside SampleDecoderOnlyOutput###")
    ...
    hidden_states: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    premature_layer_dist: Optional[Dict[int, int]] = None
    layer_tokens: Optional[Dict[Dict, Dict]] = None
...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        if is_greedy_gen_mode and dola_decoding:
            ...
            print("##inside dola_greedy_decode##")
        ...
        if is_greedy_gen_mode and contrastive_decoding:
            ...
            # 11. run greedy search
            print("##inside contrastive_greedy_decode##")
            ...
            print("##inside contrastive_search##")
            ...
            # 13. run sample
            print("##inside contrastive_decoding_sample##")
            ...
            print("##inside group_beam_search##")
            ...
            # 13. run beam search
            print("##inside constrained_beam_search##")
    ...
    def dola_greedy_decode(
        ...
        **model_kwargs,
        ...
        layer_tokens = {l:[] for l in candidate_premature_layers + [mature_layer] + [max_layer]}
        layer_tokens_logits = {l:[] for l in candidate_premature_layers + [mature_layer] + [max_layer]}
        dola_tokens = []
        ...
        while True:
            ...
            if ANALYZE:
                ...
                print("Analyzing DoLa Token Distributions...")
                
                #self.process_dola_token_distrib(self, mature_layer, candidate_premature_layers, dict_outputs, outputs, next_token_logits)

                #layer_tokens = {l:[] for l in candidate_premature_layers + [mature_layer]}
                    
                for layer in early_exit_layers:
                    
                    print("candidate layer", layer)
                    
                    layer_next_token_logits = dict_outputs[layer][:, -1, :]
                    
                    # pre-process distribution
                    layer_next_tokens_scores = logits_processor(input_ids, layer_next_token_logits)
                    
                    # argmax --> #torch.argmax(layer_next_tokens_scores, dim=-1) 
                    layer_next_tokens = torch.topk(layer_next_tokens_scores.flatten(), top_argmax).indices
                    layer_logits = layer_next_tokens_scores.flatten()[torch.topk(layer_next_tokens_scores.flatten(), top_argmax).indices]

                    layer_tokens[layer].append(layer_next_tokens)
                    layer_tokens_logits[layer].append(layer_logits)

                layer_tokens[max_layer].append(next_tokens)
                next_tokens_logits = next_tokens_scores.flatten()[torch.topk(next_tokens_scores.flatten(), 1).indices]
                layer_tokens_logits[max_layer].append(next_tokens_logits)

                layer_tokens_dict["layer_tokens"] = layer_tokens
                layer_tokens_dict["layer_tokens_logits"] = layer_tokens_logits
        ...
        if return_dict_in_generate:
            ...
            if self.config.is_encoder_decoder:
                ...
                print("###inside utils dola_greedy_search ###")
                ...
                return GreedySearchDecoderOnlyOutput(
                    ...
                    layer_tokens=layer_tokens_dict,
                )
        else:
    ...
    #### zarreen update ####
    # def process_dola_token_distrib(self, mature_layer, candidate_premature_layers, dict_outputs, outputs, dola_logits):
    ...
    #         # pre-process distribution
    #         next_tokens_scores = logits_processor(input_ids, layer_next_token_logits)
